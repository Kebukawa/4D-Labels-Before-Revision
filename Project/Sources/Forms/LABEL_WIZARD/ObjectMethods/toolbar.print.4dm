...
Case of 
	...
	: ($Lon_formEvent=On Clicked:K2:4)
		...
		If (OK=1)
			...
			//print
			//Print_label(C_MASTER_TABLE; OB Get((OBJECT Get pointer(Object named; "object"))->; "dom"; Is text))
			LBL_Print_label(C_MASTER_TABLE; OB Get:C1224((OBJECT Get pointer:C1124(Object named:K67:5; "object"))->; "dom"; Is text:K8:3))  //by kebu
